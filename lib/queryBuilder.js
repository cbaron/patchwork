module.exports = Object.create( {
    ...
    getQuery: function() {
        var selectArray = this.tables[ this.path[1] ].columns.map( column => this.format( '%s.%s', this.path[1], column.name ) )
            ctr = 1,
            fromString = this.path[1] + " ",
        ...
        Object.keys( this.query ).forEach( key => {
            ...
            where.values.push( this.query[ key ] )
        } )
