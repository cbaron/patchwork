...
--
-- Name: contactinfo; Type: TABLE; Schema: public; Owner: scott; Tablespace: 
--
...
ALTER TABLE contactinfo OWNER TO scott;

--
-- Name: contactinfo_id_seq; Type: SEQUENCE; Schema: public; Owner: scott
--
...
ALTER TABLE contactinfo_id_seq OWNER TO scott;

--
-- Name: contactinfo_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: scott
--
...
--
-- Data for Name: contactinfo; Type: TABLE DATA; Schema: public; Owner: scott
--
...
--
-- Name: contactinfo_id_seq; Type: SEQUENCE SET; Schema: public; Owner: scott
--
...
--
-- Name: contactinfo_pkey; Type: CONSTRAINT; Schema: public; Owner: scott; Tablespace: 
--
