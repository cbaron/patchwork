    ...
    POST() {
        ...
        .then( () => {
            ...
            return this.Postgres.query(
                `UPDATE person SET name = $1, email = $2, "secondaryEmail" = $3 WHERE id = $4`,
                [ this.body.name, this.body.email.toLowerCase(), this.body.secondaryEmail.toLowerCase(), this.user.id ]
            )
